...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__env_json__ = __webpack_require__(26);
...
var Env = function () {
  function Env() {
    ...
    Object.keys(__WEBPACK_IMPORTED_MODULE_0__env_json___default.a).forEach(function (key) {
      _this.set(key, __WEBPACK_IMPORTED_MODULE_0__env_json___default.a[key]);
    });
  }
...
module.exports = {"client_id":1,"client_secret":"ybJukfK3YxBrVVsLc9leo6a94h5zCX1s7LIFegl5","api":"http://localhost:8000","accept":"application/json"}
...
var Binance = function () {
  ...
  _createClass(Binance, [{
    ...
    key: 'fetch',
    value: function fetch(endpoint, options) {
      var _this2 = this;

      options.symbol = options.symbol.toUpperCase();
      return new Promise(function (resolve, reject) {
        axios.get(_this2.state.api + endpoint + _this2._objToUrl(options)).then(function (_ref) {
          var data = _ref.data;
    ...
    value: function listen(func) {
      ...
      this.state.ws.addEventListener('message', function (event) {
        ...
        if (d.e === 'kline') {
          var _d = data.k;
          data.kline = {
            times: { close: _d.T, start: _d.t },
            symbol: _d.s,
            interval: _d.i,
            tradeIDs: { first: _d.f, last: _d.L },
            prices: { open: _d.o, close: _d.c, high: _d.h, low: _d.l },
            volumes: { base: _d.v, quote: _d.q, takerBase: _d.V, takerQuote: _d.Q },
            trades: _d.n,
            isClosed: _d.x,
            ignore: _d.B
          };
...
/* harmony default export */ __webpack_exports__["a"] = (new Binance());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__classes_Env__ = __webpack_require__(25);



window.env = new __WEBPACK_IMPORTED_MODULE_1__classes_Env__["a" /* default */]();
...
var store = new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store(__webpack_require__(20));
...
Component.options.__file = "src/pages/charts.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0f9c7d4e", Component.options)
  } else {
    hotAPI.reload("data-v-0f9c7d4e", Component.options)
  }
...
var update = __webpack_require__(10)("3ae56b55", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0f9c7d4e\",\"scoped\":false,\"hasInlineConfig\":true}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./charts.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0f9c7d4e\",\"scoped\":false,\"hasInlineConfig\":true}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./charts.vue");
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__classes_Binance__ = __webpack_require__(318);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mounted: function mounted() {
    ...
    __WEBPACK_IMPORTED_MODULE_0__classes_Binance__["a" /* default */].fetch('klines', { symbol: 'BTCUSDT', interval: '1m', limit: 5 }).then(function (data) {
      console.log(data);
    });
    __WEBPACK_IMPORTED_MODULE_0__classes_Binance__["a" /* default */].listen(function (data) {
  ...
  methods: {
    draw: function draw() {
      ...
      var data = google.visualization.arrayToDataTable([['Mon', 0, 28, 38, 45], ['Tue', 31, 38, 55, 66], ['Wed', 50, 55, 77, 80], ['Thu', 77, 77, 66, 50], ['Fri', 68, 66, 22, 15]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0f9c7d4e", module.exports)
  }
}
